...
#define STRING_CONFIG_H_AUTHOR "Jack Wilsdon <jack.wilsdon@gmail.com>" // Who made the changes.
...
#define DELTA
  ...
  #define DELTA_HEIGHT 342.20 // get this value from auto calibrate

  #define DELTA_ENDSTOP_ADJ { 0.0, -0.04, -0.17 } // get these from auto calibrate

  // Horizontal distance bridged by diagonal push rods when effector is centered.
  #define DELTA_RADIUS 98.91 //mm  Get this value from auto calibrate

  // Trim adjustments for individual towers
  // tower angle corrections for X and Y tower / rotate XYZ so Z tower angle = 0
  // measured in degrees anticlockwise looking from above the printer
  #define DELTA_TOWER_ANGLE_TRIM { -0.86, 0.20, -0.15 } // get these values from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 77, 77, 79, 111 }  // default steps per unit for Kossel (GT2, 20 tooth)
...
#define DEBUG_LEVELING_FEATURE
  ...
  #define ABL_PROBE_PT_2_X -52
  #define ABL_PROBE_PT_2_Y -30
  #define ABL_PROBE_PT_3_X 52
